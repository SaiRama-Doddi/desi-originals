        ...
        <div className="md:hidden bg-gradient-to-b from-red-500 to-orange-500 px-4 py-3 space-y-3">
          {links.map((link) => (
            <a
              ...
              className="block text-lg font-medium hover:text-yellow-200 transition"
            >
              {link.name}
            </a>
          ))}
          <button
            ...
            className="flex items-center gap-2 bg-white/20 hover:bg-white/30 rounded-md px-4 py-2 w-full justify-center"
          >
